document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("formulario").addEventListener('submit', Validacampos); 
  });
   alert(resultado);
...
function Validacampos()
{
                          ...
                          email = document.getElementById("email").value;
                             ...
                             if(nombre === "") { //si nombre es igual a cero texto
                              ...
                              if(apellido === "") { //si apellido es igual a cero texto
                             ...
                             if(email === "") { //si email es igual a cero texto
                                ...
                                if (document.getElementById("ciudades").selectedIndex==0) //verifico si el index esta en cero
                                {
                                 ...
                                 //valido la PROVINCIA
                                if (document.getElementById("provincias").selectedIndex==0) //verifico si el index esta en cero
                                {
                                 alert("Elija una ciudad para continuar")
...
//Funcion para mostrar la direccion en google maps desde el boton al hacer click
 function mostrarLugar(){
  ...
  function Confirmarenviar() {
    ...
    var mensaje = confirm("¿Se enviarán los datos,Todos están corectos?");
    ...
    alert("¡Los datos no se enviarán");
    }
    }